const CONFIG = {
  ...
  SITE_CREATE_TIME: '2023-10-29', // 建站日期，用于计算网站运行的第几天

  // 首页顶部通知条滚动内容，如不需要可以留空 []
  NOTICE_BAR: [
    { title: '欢迎来到我的博客！', url: 'https://blog.imoscarz.eu.org' },
    { title: '网站正常运行中...', url: 'https://status.imoscarz.eu.org' },
    { title: '关于博主...', url: 'https://imoscarz.eu.org' }
  ],

  // 英雄区(首页顶部大卡)
  HERO_TITLE_1: '分享编程',
  HERO_TITLE_2: '与思维认知',
  HERO_TITLE_3: 'imoscarz的博客',
  HERO_TITLE_4: '更多推荐',
  HERO_TITLE_5: process.env.HEO_RECOMMAND_TITLE || '欢迎来到我的博客！',
  HERO_TITLE_LINK: process.env.HEO_RECOMMAND_URL || '/',

  // 英雄区显示三个置顶分类
  HERO_CATEGORY_1: { title: '技术分享', url: '/tag/技术分享' },
  HERO_CATEGORY_2: { title: '必看精选', url: '/tag/必看精选' },
  HERO_CATEGORY_3: { title: '文档教程', url: '/tag/文档教程' },
  ...
  INFO_CARD_URL: 'https://imoscarz.eu.org', // 个人资料底部按钮链接
